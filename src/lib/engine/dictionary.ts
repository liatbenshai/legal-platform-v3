...
export const dictionary: Record<string, InflectedWord> = {
  ...
  'נותן': { male: 'נותן', female: 'נותנת', plural: 'נותנים' },
  'בוחר': { male: 'בוחר', female: 'בוחרת', plural: 'בוחרים' },
  'סומך': { male: 'סומך', female: 'סומכת', plural: 'סומכים' },
  'מאמין': { male: 'מאמין', female: 'מאמינה', plural: 'מאמינים' },
  ...
  'לקוח_תפקיד': { male: 'לקוח', female: 'לקוחה', plural: 'לקוחות' },
  'עורך_דין_תפקיד': { male: 'עורך דין', female: 'עורכת דין', plural: 'עורכי דין' },
  'מצווה_תפקיד': { male: 'המצווה', female: 'המצווה', plural: 'המצווים' },
  'יורש_תפקיד': { male: 'יורש', female: 'יורשת', plural: 'יורשים' },
  'מנהל_עיזבון_תפקיד': { male: 'מנהל עיזבון', female: 'מנהלת עיזבון', plural: 'מנהלי עיזבון' },
  'בן_זוג': { male: 'בעלי', female: 'אשתי', plural: 'בני הזוג' },
  ...
  'ימצה': { male: 'ימצה', female: 'תמצה', plural: 'ימצו' },
  'יברר': { male: 'יברר', female: 'תברר', plural: 'יבררו' },
  'יעקוב': { male: 'יעקוב', female: 'תעקוב', plural: 'יעקבו' },
  'ישכיר': { male: 'ישכיר', female: 'תשכיר', plural: 'ישכירו' },
  ...
  'יבחן': { male: 'יבחן', female: 'תבחן', plural: 'יבחנו' },
  ...
  'יידע': { male: 'יידע', female: 'תיידע', plural: 'יידעו' },
  'יפדה': { male: 'יפדה', female: 'תפדה', plural: 'יפדו' },
  'ימשוך': { male: 'ימשוך', female: 'תמשוך', plural: 'ימשכו' },
  'יעניק': { male: 'יעניק', female: 'תעניק', plural: 'יעניקו' },
  'ימלא': { male: 'ימלא', female: 'תמלא', plural: 'ימלאו' },
  'יצרף': { male: 'יצרף', female: 'תצרף', plural: 'יצרפו' },
  'ינקוט': { male: 'ינקוט', female: 'תנקוט', plural: 'ינקטו' },
  'ישתמש': { male: 'ישתמש', female: 'תשתמש', plural: 'ישתמשו' },
  'יכין': { male: 'יכין', female: 'תכין', plural: 'יכינו' },
  'ישתתף': { male: 'ישתתף', female: 'תשתתף', plural: 'ישתתפו' },
  'יבהיר': { male: 'יבהיר', female: 'תבהיר', plural: 'יבהירו' },
  'יבקש': { male: 'יבקש', female: 'תבקש', plural: 'יבקשו' },
  'יסכים': { male: 'יסכים', female: 'תסכים', plural: 'יסכימו' },
  'יוותר': { male: 'יוותר', female: 'תוותר', plural: 'יוותרו' },
  'יתעקש': { male: 'יתעקש', female: 'תתעקש', plural: 'יתעקשו' },
  'יחפש': { male: 'יחפש', female: 'תחפש', plural: 'יחפשו' },
  'יכבד': { male: 'יכבד', female: 'תכבד', plural: 'יכבדו' },
  'ימסור': { male: 'ימסור', female: 'תמסור', plural: 'ימסרו' },
  'יחשוף': { male: 'יחשוף', female: 'תחשוף', plural: 'יחשפו' },
  ...
  'שייך': { male: 'שייך', female: 'שייכת', plural: 'שייכים' },
  'אהוב': { male: 'אהוב', female: 'אהובה', plural: 'אהובים' },
  'מוצדק': { male: 'מוצדק', female: 'מוצדקת', plural: 'מוצדקים' },
  'נושא': { male: 'נושא', female: 'נושאת', plural: 'נושאים' },
  'נוהג': { male: 'נוהג', female: 'נוהגת', plural: 'נוהגים' },
  'מקבל': { male: 'מקבל', female: 'מקבלת', plural: 'מקבלים' },
  'מפסיק': { male: 'מפסיק', female: 'מפסיקה', plural: 'מפסיקים' },
  'מטיל': { male: 'מטיל', female: 'מטילה', plural: 'מטילים' },
  'מצדיק': { male: 'מצדיק', female: 'מצדיקה', plural: 'מצדיקים' },
  'מורה': { male: 'מורה', female: 'מורה', plural: 'מורים' },
  'משמש': { male: 'משמש', female: 'משמשת', plural: 'משמשים' },
  'סבור': { male: 'סבור', female: 'סבורה', plural: 'סבורים' },
  'קרוב': { male: 'קרוב', female: 'קרובה', plural: 'קרובים' },
  'עשוי': { male: 'עשוי', female: 'עשויה', plural: 'עשויים' },
  'מקפיד': { male: 'מקפיד', female: 'מקפידה', plural: 'מקפידים' },
  'אוכל': { male: 'אוכל', female: 'אוכלת', plural: 'אוכלים' },
  'רגיל': { male: 'רגיל', female: 'רגילה', plural: 'רגילים' },
  ...
  'חושש': { male: 'חושש', female: 'חוששת', plural: 'חוששים' },
  'מבוגר': { male: 'מבוגר', female: 'מבוגרת', plural: 'מבוגרים' },
  'אוהב': { male: 'אוהב', female: 'אוהבת', plural: 'אוהבים' },
  'מצויד': { male: 'מצויד', female: 'מצוידת', plural: 'מצוידים' },
  'מעורפל': { male: 'מעורפל', female: 'מעורפלת', plural: 'מעורפלים' },
  'צריך': { male: 'צריך', female: 'צריכה', plural: 'צריכים' },
  'מתחייב': { male: 'מתחייב', female: 'מתחייבת', plural: 'מתחייבים' },
  'משחרר': { male: 'משחרר', female: 'משחררת', plural: 'משחררים' },
  'מתנהג': { male: 'מתנהג', female: 'מתנהגת', plural: 'מתנהגים' },
  'מצפה': { male: 'מצפה', female: 'מצפה', plural: 'מצפים' },
  'מגביל': { male: 'מגביל', female: 'מגבילה', plural: 'מגבילים' },
  'נהנה': { male: 'נהנה', female: 'נהנית', plural: 'נהנים' },
  ...
  'מיוזמתו': { male: 'מיוזמתו', female: 'מיוזמתה', plural: 'מיוזמתם' },
  'כיסו': { male: 'כיסו', female: 'כיסה', plural: 'כיסם' },
